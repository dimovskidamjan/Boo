...
SWIFT_MODULE_NAMESPACE_PUSH("Ghost")
@class NSMenuItem;

SWIFT_CLASS("_TtC5Ghost11AppDelegate")
@interface AppDelegate : NSObject <NSApplicationDelegate>
@property (nonatomic) BOOL startAtLogin;
- (void)applicationDidFinishLaunching:(NSNotification * _Nonnull)aNotification;
- (void)toggleHideFiles:(NSMenuItem * _Nonnull)sender;
- (void)toggleLaunchOnStart:(NSMenuItem * _Nonnull)sender;
